...
namespace SaleWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            //adicionar Departments ao banco de dados
            _context.Department.AddRange(d1, d2, d3, d4);

            //adicionar Sellers ao banco de dados
            _context.Seller.AddRange(s1, s2, s3, s4, s5, s6);

            //adicionar SalesRecords ao banco de dados
            ...
            /* outra forma de popular os dados: https://code-maze.com/migrations-and-seed-data-efcore/ */
